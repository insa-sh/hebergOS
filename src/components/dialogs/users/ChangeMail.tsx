...
import { ChangeMailFormSchema, SessionUser, UserLight } from "@/lib/definitions";
...
export default function ChangeMail({ user, children, open, setOpen }: { user: SessionUser | UserLight, children?: React.ReactNode, open?: boolean, setOpen?: React.Dispatch<React.SetStateAction<boolean>> }) {
