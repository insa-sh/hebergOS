...
import { ChangeNicknameFormSchema, SessionUser, UserLight } from "@/lib/definitions";
...
export default function ChangeNickname({ user, children, open, setOpen }: { user: SessionUser | UserLight, children?: React.ReactNode, open?: boolean, setOpen?: React.Dispatch<React.SetStateAction<boolean>> }) {
